...
import org.simmetrics.CodePointDistanceTest;
import org.simmetrics.CodePointMetric;
import org.simmetrics.CodePointMetricTest;
...
public class DamerauLevenshteinTest {
	...
	public static final class OutofBounds {
		...
		public void shouldThrowForDeleteCostOnBound() {
			new DamerauLevenshtein.Impl(0, 1, 1);
		}

		@Test(expected = IllegalArgumentException.class)
		public void shouldThrowForDeleteCostBelowBound() {
			new DamerauLevenshtein.Impl(-1f, 1, 1);
		}

		@Test(expected = IllegalArgumentException.class)
		public void shouldThrowForsubstituteCostBelowBound() {
			new DamerauLevenshtein.Impl(1, -Float.MIN_VALUE, 1);
		}

		@Test(expected = IllegalArgumentException.class)
		public void shouldThrowForTransposeCostBelowBound() {
			new DamerauLevenshtein.Impl(1, 1, -Float.MIN_VALUE);
		}
	}

	@RunWith(Enclosed.class)
	public static final class DistanceCodePoints {

		public static final class UnitCost extends CodePointDistanceTest {

			@Override
			protected CodePointDistance getMetric() {
				return DamerauLevenshtein.forCodePoints();
			}
	...
	@RunWith(Enclosed.class)
	public static final class DistanceList {

		public static final class UnitCost extends ListDistanceTest {

			@Override
			protected ListDistance<String> getMetric() {
				return DamerauLevenshtein.forLists();
			}
			...
			@Override
			protected T[] getTests() {
				Tokenizer t = Tokenizers.qGram(1);
				return new T[] {

						new T(t, 1.0000f, "test string1", "test string2"),
						new T(t, 8.0000f, "test", "test string2"),
						new T(t, 12.0000f, "", "test string2"),
						new T(1.0000f, 
							asList("a", "b", "c", "f"),
							asList("a", "b", "c", null)),
						new T(t, 3.0000f, "aaa bbb ccc ddd", "aaa bbb ccc eee"),
						new T(t, 3.0000f, "aaa bbb", "aaa aaa"),
						new T(t, 4.0000f, "aaa", "aaa aaa"),
						new T(t, 1.0000f, "a b c d", "a b c e"),
						new T(t, 1.0000f, "uxyw", "uyxw"),
						new T(t, 4.0000f, "uxaayw", "uyxw"),
						new T(t, 1.0000f, "transpose", "tranpsose"),
						new T(t, 1.0000f, "Healed", "Sealed"),
						new T(t, 3.0000f, "Healed", "Healthy"),
						new T(t, 2.0000f, "Healed", "Heard"),
						new T(t, 2.0000f, "Healed", "Herded"),
						new T(t, 3.0000f, "Healed", "Help"),
						new T(t, 4.0000f, "Healed", "Sold"),
						new T(t, 3.0000f, "Healed", "Help"),
						new T(t, 6.0000f, "Sam J Chapman", "Samuel John Chapman"),
						new T(t, 2.0000f, "Sam Chapman", "S Chapman"),
						new T(t, 14.0000f, "John Smith", "Samuel John Chapman"),
						new T(t, 11.0000f, "John Smith", "Sam Chapman"),
						new T(t, 12.0000f, "John Smith", "Sam J Chapman"),
						new T(t, 9.0000f, "John Smith", "S Chapman"),
						new T(t, 17.0000f, "Web Database Applications",
								"Web Database Applications with PHP & MySQL"),
						new T(t, 28.0000f, "Web Database Applications",
								"Creating Database Web Applications with PHP and ASP"),
						new T(t, 30.0000f, "Web Database Applications",
								"Building Database Applications on the Web Using PHP3"),
						new T(t, 30.0000f, "Web Database Applications",
								"Building Web Database Applications with Visual Studio 6"),
						new T(t, 27.0000f, "Web Database Applications",
								"Web Application Development With PHP"),
						new T(t, 
								62.0000f,
								"Web Database Applications",
								"WebRAD: Building Database Applications on the Web with Visual FoxPro and Web Connection"),
						new T(t, 53.0000f, "Web Database Applications",
								"Structural Assessment: The Role of Large and Full-Scale Testing"),
						new T(t, 27.0000f, "Web Database Applications",
								"How to Find a Scholarship Online"),
						new T(t, 27.0000f, "Web Aplications",
								"Web Database Applications with PHP & MySQL"),
						new T(t, 36.0000f, "Web Aplications",
								"Creating Database Web Applications with PHP and ASP"),
						new T(t, 39.0000f, "Web Aplications",
								"Building Database Applications on the Web Using PHP3"),
						new T(t, 40.0000f, "Web Aplications",
								"Building Web Database Applications with Visual Studio 6"),
						new T(t, 22.0000f, "Web Aplications",
								"Web Application Development With PHP"),
						new T(t, 
								72.0000f,
								"Web Aplications",
								"WebRAD: Building Database Applications on the Web with Visual FoxPro and Web Connection"),
						new T(t, 56.0000f, "Web Aplications",
								"Structural Assessment: The Role of Large and Full-Scale Testing"),
						new T(t, 26.0000f, "Web Aplications",
								"How to Find a Scholarship Online"), };
			}
		}
	}
	...
	@RunWith(Enclosed.class)
	public static final class MetricCodePointTest {

		public static final class UnitCost extends CodePointMetricTest {

			@Override
			protected CodePointMetric getMetric() {
				return DamerauLevenshtein.forCodePoints();
			}
	...
	public static final class MetricStringTest {
		...
		public static final class InsertDeleteCost extends StringMetricTest {
			...
			protected Metric<String> getMetric() {
				return DamerauLevenshtein.forStrings(0.1f, 1.0f, 1.0f);
			}
		...
		public static final class NoSubstituteCost extends StringMetricTest {
			@Override
			protected Metric<String> getMetric() {
				return DamerauLevenshtein.forStrings(1.0f, 0.0f, 1.0f);
			}
		...
		public static final class LowSubstituteCost extends StringMetricTest {
			...
			@Override
			protected Metric<String> getMetric() {
				return DamerauLevenshtein.forStrings(1.0f, 0.2f, 1.0f);
			}
		...
		public static final class NoTransposeCost extends StringMetricTest {
			...
			@Override
			protected Metric<String> getMetric() {
				return DamerauLevenshtein.forStrings(1.0f, 1.0f, 0.0f);
			}
			...
			@Override
			protected T[] getTests() {
				return new T[] { new T(0.000f, "uxyw", ""),
		...
		public static final class LowTransposeCost extends StringMetricTest {
			...
			@Override
			protected Metric<String> getMetric() {
				return DamerauLevenshtein.forStrings(1.0f, 1.0f, 0.1f);
			}
			...
			@Override
			protected T[] getTests() {
				return new T[] { new T(0.0000f, "uxyw", ""),
